...
この索引は、具体的な執筆準備に入った短編計画を管理する場所。短編集全体の未確定な種は `notes/04-story-seeds.md` に残し、個別短編として場面・視点・結末候補を詰める段階になったものだけをここへ登録する。
...
- `notes/stories/`: 短編ごとのアウトライン、視点設計、場面順、結末候補。
- `stories/`: 実際の短編本文ドラフト。
- `notes/04-story-seeds.md`: 短編集全体の候補リスト。
